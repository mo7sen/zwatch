...
func walk(delta: float) -> void:
	...
	if direction.length_squared() > 0:
		...
		animation_tree.set("parameters/conditions/not_walking", false)
	else:
		animation_tree.set("parameters/conditions/walking", false)
		animation_tree.set("parameters/conditions/not_walking", true)
	
	animation_tree.set("parameters/conditions/sprinting", sprinting)
	animation_tree.set("parameters/conditions/not_sprinting", !sprinting)
	# Move
